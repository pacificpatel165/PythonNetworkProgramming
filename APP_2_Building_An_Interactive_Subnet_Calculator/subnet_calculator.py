...
def subnet_calc():
    try:
        ...
        # We will end up with 4 slices of the binary IP address: [0: 8], [8: 16], [16: 24] and [24:31]; remember that
        # each slice goes up to, but not including, the index on the right side of the colon!
